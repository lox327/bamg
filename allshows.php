...
echo "<br /><div class=\"weekof\">week of: [" . $newdate1a . "]</div></div>";
...
while($show_info = mysql_fetch_array($check2)) {
	...
	if ($venue_info['active']==1) {
		echo "<a href=\"venueinfo.php?venueid=" . $show_info['venueid'] . "&showid=" . $show_info['showid'] . "\"><div class=\"post_meta\"><table><tr><td style=\"width:70px;background-color:#808080;\">";
...
if ($page==1) echo "<table width=\"100%\"><tr><td align=\"left\" width=\"50%\"></td>";
else echo "<table width=\"100%\"><tr><td align=\"left\" width=\"50%\"><a class=\"yellowBtn\" href=\"?page=$prev\">< PREV week</a></td>";
echo "<td align=\"right\" width=\"50%\"><a class=\"yellowBtn\" href=\"?page=$next\">NEXT week ></a></td></tr></table>";
